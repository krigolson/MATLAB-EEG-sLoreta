...
%   Brainstorm ICBM152 pial cortex. Source-grid values are interpolated to
...
cortex = load(cortexFile, 'Vertices', 'Faces');
vertices = cortex.Vertices;
faces = cortex.Faces;

% Brainstorm stores this template in meters; our leadfield source positions
% are in millimeters.
